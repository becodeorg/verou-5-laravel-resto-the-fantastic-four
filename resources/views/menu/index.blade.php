...
@section('content')
    <div class="bg-gray-900">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          ...
          <h2 class="mt-24 text-4xl text-center font-bold tracking-tight text-white sm:mt-10 sm:text-2xl">Appetizers</h2><br><br>
            <div class="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 lg:grid-cols-3 lg:gap-x-8">
                ...
                <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                    <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                        <img src="{{ asset('images/Cheese_Wraps.jpg') }}"
                            alt="Cheese Wraps"
                            class="h-full w-full object-cover object-center sm:h-full sm:w-full">
                    </div>
                    <div class="flex flex-1 flex-col space-y-2 p-4">
                        ...
                        <p class="text-sm text-gray-500">"Say Cheese! Our Gourmet Wraps Are The Perfect Blend of Comfort and Class!"</p>
                        <div class="flex flex-1 flex-col justify-end">
                ...
                <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                  <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                      <img src="{{ asset('images/AntiPasti_Bites.jpg') }}"
                          alt="AntiPasti Bites"
                          class="h-full w-full object-cover object-center sm:h-full sm:w-full">
                  </div>
                  <div class="flex flex-1 flex-col space-y-2 p-4">
                      ...
                      <p class="text-sm text-gray-500">"A Taste of Tradition: Savor Every Moment with Our Antipasti Bites!"</p>
                      <div class="flex flex-1 flex-col justify-end">
              ...
              <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                    <img src="{{ asset('images/Stuffed_Baguette.jpg') }}"
                        alt="Stuffed Baguette"
                        class="h-full w-full object-cover object-center sm:h-full sm:w-full">
                </div>
                <div class="flex flex-1 flex-col space-y-2 p-4">
                    <h3 class="text-sm font-medium text-gray-900">
                    ...
                    <p class="text-sm text-gray-500">"Crusty on the Outside, Heavenly Inside: Discover the Delight of Our Stuffed Baguettes!"</p>
                    <div class="flex flex-1 flex-col justify-end">
            ...
            <div class="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 lg:grid-cols-3 lg:gap-x-8">
                ...
                <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                  <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                      <img src="{{ asset('images/Patato_Gratin.jpg') }}"
                          alt="Potato Gratin"
                          class="h-full w-full object-cover object-center sm:h-full sm:w-full">
                  </div>
                  <div class="flex flex-1 flex-col space-y-2 p-4">
              ...
              <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                    <img src="{{ asset('images/Spaghetti_Bolognese.jpg') }}"
                ...
                <div class="flex flex-1 flex-col space-y-2 p-4">
                    ...
                    <p class="text-sm text-gray-500">"Twirl into Comfort: Our Spaghetti Bolognese, Where Tradition Meets Taste!"</p>
                    <div class="flex flex-1 flex-col justify-end">
            ...
            <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
              <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                  <img src="{{ asset('images/Grilled_Salmon.jpg') }}"
                      alt="Grilled Salmon"
                      class="h-full w-full object-cover object-center sm:h-full sm:w-full">
              </div>
              <div class="flex flex-1 flex-col space-y-2 p-4">
                  ...
                  <p class="text-sm text-gray-500">"Ocean's Bounty: Savor the Succulent Perfection of Our Grilled Salmon!"</p>
                  <div class="flex flex-1 flex-col justify-end">
        ...
        <h2 class="mt-24 text-4xl text-center font-bold tracking-tight text-white sm:mt-10 sm:text-2xl">Desserts</h2><br><br>
            <div class="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 lg:grid-cols-3 lg:gap-x-8">
                <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                    ...
                    <div class="flex flex-1 flex-col space-y-2 p-4">
                        ...
                        <p class="text-sm text-gray-500">"A Symphony of Flavors: Explore Our Exquisite Cheese Plank Selection!"</p>
                        <div class="flex flex-1 flex-col justify-end">
                ...
                <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                  ...
                  <div class="flex flex-1 flex-col space-y-2 p-4">
                      ...
                      <p class="text-sm text-gray-500">"A Scoop of Happiness: Indulge in Our Irresistible Ice Cream Creations!"</p>
                      <div class="flex flex-1 flex-col justify-end">
              ...
              <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
                ...
                <div class="flex flex-1 flex-col space-y-2 p-4">
                    ...
                    <p class="text-sm text-gray-500">"Berry Bliss: Whipped Yogurt with Roasted Strawberries - A Delightful Symphony of Flavors!"</p>
                    <div class="flex flex-1 flex-col justify-end">
            ...
            <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
              <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                  <img src="{{ asset('images/CheeseCake.jpg') }}"
                      alt="Cheese Cake"
                      class="h-full w-full object-cover object-center sm:h-full sm:w-full">
              </div>
              <div class="flex flex-1 flex-col space-y-2 p-4">
