    ...
    <div class="grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6 sm:gap-y-10 lg:grid-cols-4 lg:gap-x-8">
        ...
        <div class="group relative flex flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
            <div class="aspect-h-4 aspect-w-3 bg-gray-200 sm:aspect-none group-hover:opacity-75 sm:h-96">
                <img src="{{ asset('images/'.$Appetizer->image) }}"
                    alt="{{ $Appetizer->name }}"
            ...
            <div class="flex flex-1 flex-col space-y-2 p-4">
                ...
                <p class="text-sm text-gray-500">{{ $Appetizer->description }}</p>
                <div class="flex flex-1 flex-col justify-end">
                    <p class="text-sm italic text-gray-500">{{ $Appetizer->tag }}</p>
                    <p class="text-base font-medium text-gray-900">${{ $Appetizer->price }}</p>
                </div>
            </div>
        </div>
        @endforeach
