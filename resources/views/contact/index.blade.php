            ...
            <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
                <div class="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
                    <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                        ...
                        <p class="mt-6 text-lg leading-8 text-gray-300">Craving more information? Our team is ready to
                            answer your call and sprinkle some extra zest into your day! Whether it's to book a table,
                            inquire about our menu, or simply share your thoughts, we're all ears—like corn, but more
                            attentive. Use the form to drop us a message or pick up the phone for a chat that's as warm and
                            inviting as our freshly-baked bread. Let's cook up a conversation!</p>
