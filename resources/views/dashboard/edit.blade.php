...
@section('content')
    ...
    <a href="{{ route('editMenu') }}" class="p-1 bg-gray-500 text-white rounded-md hover:bg-gray-600 mb-5">GO BACK</a>
    <div>
        <form action="{{ route('update-menu') }}" method="POST">
            ...
            <input class="block mb-5" type="text" name="name" id="name" value="{{ $item->name }}">
            ...
            <input class="block mb-5" type="number" name="price" id="price" value="{{ $item->price }}">
            <label class="block" for="image">Image URL:</label>
            <input class="block mb-5" type="text" name="image" id="image" value="{{ $item->image }}">
