...
<body class="bg-transparent">
    <div class="relative min-h-screen flex items-center justify-center">
        ...
        <img class="absolute inset-0 w-full h-full object-cover z-0" src="{{ asset('images/pexels-roman-odintsov-4551832.jpg') }}" alt="Background">
